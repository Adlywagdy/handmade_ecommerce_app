      ...
      builder: (context, child) {
        return MultiBlocProvider(
          providers: [
            ...
            BlocProvider(create: (BuildContext context) => NotificationsCubit()..loadNotifications(),),
            BlocProvider( create: (BuildContext context) => SellerCubit(SellerFirestoreService())..loadDashboard(), ),
            BlocProvider( create: (BuildContext context) => LocaleCubit()..loadSavedLocale(), ),
          ],
