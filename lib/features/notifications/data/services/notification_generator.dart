...
class NotificationGenerator {
  ...
  static Future<void> _sendToUser(
    ...
    try {
      ...
      debugPrint(
        '🔔 Notification successfully written to Firestore for user: $userId',
      );
    } catch (e) {
  ...
  static Future<void> onLowStock({
    ...
    await _sendToUser(
      ...
      NotificationModel(
        ...
        body:
            '"$productName" has only $remaining units left. Consider restocking.',
  ...
  static Future<void> onOrderStatusChanged({
    ...
    switch (newStatus.toLowerCase()) {
      ...
      case 'shipped':
        ...
        body =
            'Order $orderId has been shipped. Expected delivery in 3-5 days.';
        break;
      case 'delivered':
  ...
  static Future<void> onReviewRequest({
    ...
    await _sendToUser(
      ...
      NotificationModel(
        ...
        body:
            'How was your experience with "$productName"? Tap to leave a review.',
        type: NotificationType.productReview,
        createdAt: DateTime.now(),
        targetId: productId,
      ),
