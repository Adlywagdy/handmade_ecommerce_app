        ...
        child: Column(
          children: [
            ...
            if (showActions) ...[
              ...
              _SellerCardActions(onApprove: onApprove, onReject: onReject),
            ],
          ],
        ),
      ),
...
class _SellerCardActions extends StatefulWidget {
  ...
  const _SellerCardActions({required this.onApprove, required this.onReject});
    ...
    return Row(
      children: [
        ActionButton(
          ...
          onTap: busy
              ? null
              : () => _run(approve: true, action: widget.onApprove),
        ...
        ActionButton(
          ...
          onTap: busy
              ? null
              : () => _run(approve: false, action: widget.onReject),
