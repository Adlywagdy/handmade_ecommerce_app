...
///////////////////////////////////////////
class GetCategoriesLoading extends AdminState {}

class GetCategoriesSuccess extends AdminState {}

class GetCategoriesFailure extends AdminState {
  final String error;
  GetCategoriesFailure(this.error);
}

class GetCategoriesError extends AdminState {
  final String error;
  GetCategoriesError(this.error);
}

///////////////////////////////////////////
class CategoryActionLoading extends AdminState {}

class CategoryActionSuccess extends AdminState {
  final String message;
  CategoryActionSuccess(this.message);
}

class CategoryActionError extends AdminState {
  final String error;
