...
class _SellerPendingScreenState extends State<SellerPendingScreen>
  ...
  Future<void> _refreshStatus() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(context.l10n.selCouldNotRefreshStatus(e.toString())),
        ),
      );
    } finally {
...
class _StatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final label = isRejected
        ? context.l10n.selNotApproved
        : context.l10n.selPendingApproval;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _TimelineStep(
            label: isRejected
                ? context.l10n.selReviewed
                : context.l10n.selUnderReview,
          ...
          _TimelineStep(
            label: isApproved
                ? context.l10n.selApprovedWelcomeAboard
                : context.l10n.selApproved,
            isDone: isApproved,
            isActive: false,
            isFirst: false,
            isLast: true,
            ...
            children: [
              ...
              isActive
                  ...
                  : Container(
                      ...
                      height: 22.w,
                      decoration: BoxDecoration(
                        color: isDone || isError ? accent : Colors.transparent,
                        shape: BoxShape.circle,
                      ...
                      child: isDone
                          ...
                          : isError
                          ? Icon(Icons.close, color: Colors.white, size: 14.w)
                          : null,
                    ),
              Expanded(
                child: Container(
                  width: 2.w,
                  color: isLast ? Colors.transparent : const Color(0xFFE6D7C0),
                ),
              ),
            ],
          ),
