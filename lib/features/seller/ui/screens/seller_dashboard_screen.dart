...
import 'package:handmade_ecommerce_app/features/seller/ui/widgets/seller_stat_card.dart';
import 'package:handmade_ecommerce_app/features/seller/ui/widgets/seller_best_selling_card.dart';
import 'package:handmade_ecommerce_app/features/seller/ui/widgets/seller_quick_action.dart';
import 'package:handmade_ecommerce_app/features/seller/ui/widgets/seller_order_card.dart';
import 'package:handmade_ecommerce_app/features/seller/ui/screens/seller_profile_screen.dart';
      ...
      body: SafeArea(
        child: BlocBuilder<SellerCubit, SellerState>(
          builder: (context, state) {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      context.l10n.hereWhatIsHappeningWithYourShopToday,
                      style: TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: SellerStatCard(
                            title: context.l10n.selTotalOrders,
            ...
            return Center(child: Text(context.l10n.selUnexpectedState));
          },
        ),
      ),
    );
          ...
          child: Container(
            ...
            child: ClipOval(
              child: user?.photoURL != null && user!.photoURL!.isNotEmpty
                  ...
                  : Icon(Icons.person, color: commonColor, size: 24.w),
            ),
          ),
        ),
        SizedBox(width: 12.w),
