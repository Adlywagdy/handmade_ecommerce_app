...
import 'package:handmade_ecommerce_app/features/seller/ui/widgets/seller_manage_order_card.dart';
...
import 'package:handmade_ecommerce_app/features/seller/ui/screens/seller_order_details_screen.dart';
              ...
              builder: (context, state) {
                ...
                if (state is SellerLoaded) {
                  pendingCount = state.orders
                      ...
                      .length;
                  shippedCount = state.orders
                      .where((o) => o.status.toLowerCase() == 'shipped')
                      .length;
                  completedCount = state.orders
                      .where(
                        (o) =>
                ...
                return TabBar(
                  ...
                  tabs: [
                    ...
                    Tab(
                      text: shippedCount > 0
                          ? '${context.l10n.shipped} ($shippedCount)'
                          : context.l10n.shipped,
                    ),
                    Tab(
                      text: completedCount > 0
                          ? '${context.l10n.completed} ($completedCount)'
                          : context.l10n.completed,
                    ),
                    Tab(
                      text: cancelledCount > 0
                          ? '${context.l10n.cancelled} ($cancelledCount)'
      ...
      return RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            Center(
              child: Text(
                context.l10n.selNoTabOrders(tabName),
                style: TextStyle(
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final canCancel =
              statusLower == 'pending' || statusLower == 'shipped';
          final isFinished =
          ...
          try {
            ...
            formattedDate =
                '${dt.day}/${dt.month}/${dt.year} ${dt.hour > 12 ? dt.hour - 12 : (dt.hour == 0 ? 12 : dt.hour)}:${dt.minute.toString().padLeft(2, '0')} ${dt.hour >= 12 ? 'PM' : 'AM'}';
          } catch (_) {}
          ...
          return SellerManageOrderCard(
                ...
                ? () {
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        title: Text(context.l10n.selCancelOrderTitle),
                        content: Text(
                          context.l10n.selCancelOrderContent(order.orderId),
                        ),
                        actions: [
                          TextButton(
                              ...
                              try {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        context
                                            .l10n
                                            .selOrderCancelledAndStockRestored,
                                      ),
                                ...
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        context.l10n.selFailedToCancelOrder(
                                          e.toString(),
                                        ),
                                      ),
            ...
            onButtonPressed: () {
              if (isFinished) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(context.l10n.selOrderArchivedSuccessfully),
              ...
              if (newStatus.isNotEmpty) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      context.l10n.selOrderStatusUpdatedTo(newStatus),
                    ),
